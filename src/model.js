...
function DModel() {
    ...
    this.makeBlock = function() {      return new DNode(exports.BLOCK, null, this);   };
    this.makeText = function(text) {   return new DNode(exports.TEXT,text,this);      };
    this.makeSpan = function() {       return new DNode(exports.SPAN, null, this);    };
    this.append = function(node) {     root.append(node); };

    this.getPreviousTextNode = function(tnode) {
        if(tnode.type == exports.ROOT) return null;
    ...
    this.setStyles = function(styles) { this.styles = styles; };

    this.getStyles = function() { return this.styles; };
...
exports.makeModel = function() {  return new DModel();  };
...
exports.print = function(model,tab) {
    if(!tab) tab = "";
    if(model == null) return console.log(tab + "null");
    if(model.getRoot) return exports.print(model.getRoot(),"");
    if(model.type == exports.TEXT) return console.log(tab + model.type + "#"+model.id+ "." + model.style + " '" + model.text+"'");
